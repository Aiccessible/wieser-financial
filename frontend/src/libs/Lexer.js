// ref: https://github.com/karminski/streaming-json-js/blob/main/src/index.js
// copied instead of as a dependency, because i dont want to have a random small dependency
...
class Lexer {
    ...
    streamStoppedInAnObjectKeyStart() {
        ...
        return (
            (matchStack(this.TokenStack, case1) || matchStack(this.TokenStack, case2)) &&
            ...
            switch (token) {
                ...
                case TOKEN_ALPHABET_LOWERCASE_S:
                    ...
                    this.itIsPartOfTokenFalse2 = () => {
                        let left = [TOKEN_ALPHABET_LOWERCASE_F, TOKEN_ALPHABET_LOWERCASE_A, TOKEN_ALPHABET_LOWERCASE_L]
                        let right = [TOKEN_ALPHABET_LOWERCASE_E, TOKEN_ALPHABET_LOWERCASE_S]
                        return matchStack(this.TokenStack, left) && matchStack(this.MirrorTokenStack, right)
                    }
